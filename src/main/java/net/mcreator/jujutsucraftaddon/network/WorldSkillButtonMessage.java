...
import net.mcreator.jujutsucraftaddon.procedures.SimpleDomainKeyOnKeyPressedProcedure;
import net.mcreator.jujutsucraftaddon.procedures.RCTOutputKeyOnKeyPressedProcedure;
import net.mcreator.jujutsucraftaddon.procedures.RCTMasteryKeyOnKeyPressedProcedure;
import net.mcreator.jujutsucraftaddon.procedures.RCTBurnoutKeyProcedure;
import net.mcreator.jujutsucraftaddon.procedures.ExtensionDomainKeyOnPressedProcedure;
import net.mcreator.jujutsucraftaddon.procedures.BarrierlessKeyOnKeyPressedProcedure;
...
public class WorldSkillButtonMessage {
    ...
    public WorldSkillButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
