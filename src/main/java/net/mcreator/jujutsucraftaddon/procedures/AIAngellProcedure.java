...
public class AIAngellProcedure {
                ...
                if (Math.random() >= 0.8) {
                    if (new Object() {
                        ...
                        if (Math.random() >= 0.9) {
                            ...
                            if (Math.random() < 0.4) {
                                ...
                                dataIndex22.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 2812, 2815)));
                    ...
                    if (Math.random() >= 0.7) {
                        if (new Object() {
                            ...
                            dataIndex37.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 2815, 2815)));
