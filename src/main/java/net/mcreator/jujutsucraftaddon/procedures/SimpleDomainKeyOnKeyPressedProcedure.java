...
public class SimpleDomainKeyOnKeyPressedProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof ServerPlayer _plr0 && _plr0.level() instanceof ServerLevel
			...
			if ((entity.getCapability(JujutsucraftaddonModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JujutsucraftaddonModVariables.PlayerVariables())).SimpleDomain == false) {
				{
