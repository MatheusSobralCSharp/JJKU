...
public class AIMakiZeninProcedure {
    public static void execute(LevelAccessor world, Entity sourceentity) {
        if (sourceentity == null)
            return;
        if (sourceentity instanceof MakiPreparationEntity) {
            if (!(new Object() {
                ...
                if (Math.random() >= 0.8) {
                    if (new Object() {
                        ...
                        if (Math.random() >= 0.9) {
                            ...
                            dataIndex10.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), -97, -96)));
                            ...
                            if (Math.random() < 0.4) {
                                ...
                                dataIndex22.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), -97, -96)));
                    ...
                    if (Math.random() >= 0.7) {
                        if (new Object() {
                            ...
                            dataIndex37.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), -97, -96)));
