									...
									if (!(entityiterator == entity)) {
										...
										if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
											_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 120,
													(int) ((entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(MobEffects.MOVEMENT_SPEED) ? _livEnt.getEffect(MobEffects.MOVEMENT_SPEED).getAmplifier() : 0) + 4), false, false));
									}
								}
							}
						}
								...
								if (!(entityiterator == entity)) {
									if (entityiterator instanceof LivingEntity) {
										...
										for (int index0 = 0; index0 < (int) particleAmount; index0++) {
											world.addParticle((SimpleParticleType) (JujutsucraftaddonModParticleTypes.KAI.get()), (entityiterator.getX() + 0 + Mth.nextDouble(RandomSource.create(), -0.1, 0.1) * particleRadius),
											...
											world.addParticle((SimpleParticleType) (JujutsucraftaddonModParticleTypes.HAITI.get()), (entityiterator.getX() + 0 + Mth.nextDouble(RandomSource.create(), -0.1, 0.1) * particleRadius),
													(entityiterator.getY() + 0 + Mth.nextDouble(RandomSource.create(), 0, 5) * particleRadius), (entityiterator.getZ() + 0 + Mth.nextDouble(RandomSource.create(), -0.1, 0.1) * particleRadius), 0, 0, 0);
										}
										entityiterator.hurt(
												new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation("jujutsucraft:damage_curse")))), 40);
