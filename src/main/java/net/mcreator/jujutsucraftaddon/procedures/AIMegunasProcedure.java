...
public class AIMegunasProcedure {
    public static void execute(LevelAccessor world, Entity entity, Entity sourceentity) {
        if (entity == null || sourceentity == null)
            return;
        if (sourceentity instanceof SukunaFushiguroEntity || sourceentity instanceof SukunaMangaEntity || sourceentity instanceof HusseinDongEntity || sourceentity instanceof IronkkEntity) {
            if (!(new Object() {
                ...
                if (Math.random() >= 0.8) {
                    if (new Object() {
                        ...
                        if (Math.random() >= 0.9) {
                            ...
                            dataIndex10.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 105, 107)));
                            ...
                            if (Math.random() < 0.4) {
                                ...
                                dataIndex22.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 605, 618)));
                    ...
                    if (Math.random() >= 0.7) {
                        if (new Object() {
                            ...
                            dataIndex37.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 105, 106)));
                        ...
                        if (new Object() {
                            ...
                            dataIndex50.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 605, 618)));
