				...
				if (Math.random() >= 0.8) {
					if (new Object() {
						...
						if (Math.random() >= 0.9) {
							...
							if (Math.random() < 0.4) {
								...
								dataIndex22.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 206, 208)));
					...
					if (Math.random() >= 0.7) {
						if (new Object() {
							...
							dataIndex37.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 105, 2200)));
						...
						if (new Object() {
							...
							dataIndex50.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 105, 2200)));
