	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (world instanceof ServerLevel _serverLevel) {
			...
			if (entitytospawn != null) {
				...
				dataIndex11.getCompound("ForgeData").putString("OWNER_UUID", ((entitytospawn).getStringUUID()));
				...
				dataIndex23.getCompound("ForgeData").putDouble("TenShadowsTechnique14", (-2));
				...
				dataIndex29.getCompound("ForgeData").putDouble("friend_num2", (new Object() {
					public double getValue() {
