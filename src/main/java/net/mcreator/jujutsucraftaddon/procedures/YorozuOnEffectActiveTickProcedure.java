				...
				for (Entity entityiterator : _entfound) {
					if (!(entityiterator == entity)) {
						...
						if (world instanceof ServerLevel _level)
							_level.sendParticles((SimpleParticleType) (JujutsucraftModParticleTypes.PARTICLE_LIQUID_METAL.get()), (entityiterator.getX()), (entityiterator.getY()), (entityiterator.getZ()), 1, 0, 0, 0, 1);
					}
				}
			}
		}
