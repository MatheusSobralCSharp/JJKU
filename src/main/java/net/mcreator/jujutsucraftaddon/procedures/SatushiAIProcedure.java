...
public class SatushiAIProcedure {
    public static void execute(LevelAccessor world, Entity sourceentity) {
        if (sourceentity == null)
            return;
        if (sourceentity instanceof SatushiEntity) {
            if (!(new Object() {
                    ...
                    if (new Object() {
                        ...
                        if (Math.random() >= 0.9) {
                            ...
                            if (Math.random() < 0.4) {
                                ...
                                dataIndex22.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 105, 3000)));
