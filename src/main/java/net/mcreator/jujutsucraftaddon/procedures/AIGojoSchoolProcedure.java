...
public class AIGojoSchoolProcedure {
	public static void execute(LevelAccessor world, Entity sourceentity) {
		if (sourceentity == null)
			return;
		if (sourceentity instanceof GojoSchoolEntity) {
			if (!(new Object() {
				...
				if (Math.random() >= 0.8) {
					if (new Object() {
						...
						if (Math.random() >= 0.9) {
							...
							dataIndex10.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 204, 206)));
							...
							if (Math.random() < 0.4) {
								...
								dataIndex22.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 204, 206)));
					...
					if (Math.random() >= 0.7) {
						if (new Object() {
							...
							dataIndex37.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 206, 206)));
						...
						if (new Object() {
							...
							dataIndex50.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 206, 206)));
					...
					if (!(sourceentity instanceof LivingEntity _livEnt67 && _livEnt67.hasEffect(JujutsucraftModMobEffects.INFINITY_EFFECT.get()))) {
						if (sourceentity instanceof LivingEntity _entity && !_entity.level().isClientSide())
							_entity.addEffect(new MobEffectInstance(JujutsucraftModMobEffects.INFINITY_EFFECT.get(), -1, 254, false, false));
					}
				}
			}
		}
