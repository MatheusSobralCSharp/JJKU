...
public class AIKashimoFemProcedure {
	public static void execute(LevelAccessor world, Entity sourceentity) {
		if (sourceentity == null)
			return;
		if (sourceentity instanceof KashimoFemboyEntity) {
			if (!(new Object() {
				...
				if (Math.random() >= 0.8) {
					if (new Object() {
						...
						if (Math.random() >= 0.9) {
							...
							dataIndex10.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 2904, 2905)));
							...
							if (Math.random() < 0.4) {
								...
								dataIndex22.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 705, 710)));
					...
					if (Math.random() >= 0.7) {
						if (new Object() {
							...
							dataIndex37.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), 715, 717)));
						...
						if (new Object() {
							...
							dataIndex50.getCompound("ForgeData").putDouble("skill", (Mth.nextInt(RandomSource.create(), -98, -96)));
