...
public class NueSummonProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        if (entity == null)
            return;
        if (entity.getPersistentData().getDouble("skill") == 2920 && entity.getPersistentData().getDouble("skill_domain") == 0) {
                    ...
                    synchronized (connections) {
                        ...
                        while (iterator.hasNext()) {
                            ...
                            if (!connection.isConnecting() && connection.isConnected())
                                JujutsucraftaddonMod.PACKET_HANDLER.sendTo(new SetupAnimationsProcedure.JujutsucraftaddonModAnimationMessage(Component.literal("hakaridomain"), entity.getId(), false), connection, NetworkDirection.PLAY_TO_CLIENT);
                        }
                    }
                }
            }
        } else if (entity.getPersistentData().getDouble("skill") == 220 && entity.getPersistentData().getDouble("skill_domain") == 0) {
            if (world.isClientSide()) {
                if (entity instanceof AbstractClientPlayer player) {
                    var animation = (ModifierLayer<IAnimation>) PlayerAnimationAccess.getPlayerAssociatedData(player).get(new ResourceLocation("jujutsucraftaddon", "player_animation"));
                    if (animation != null && !animation.isActive()) {
                ...
                if (entity instanceof Player && world instanceof ServerLevel srvLvl_) {
                    ...
                    synchronized (connections) {
                        ...
                        while (iterator.hasNext()) {
                            Connection connection = iterator.next();
                            if (!connection.isConnecting() && connection.isConnected())
                                JujutsucraftaddonMod.PACKET_HANDLER.sendTo(new SetupAnimationsProcedure.JujutsucraftaddonModAnimationMessage(Component.literal("infinitevoid"), entity.getId(), false), connection, NetworkDirection.PLAY_TO_CLIENT);
                        }
                    }
                }
            }
        }
        if (entity.getPersistentData().getDouble("skill") == 220) {
            {
                Entity _ent = entity;
        ...
        } else if (entity.getPersistentData().getDouble("skill") == 120) {
            if (!((entity.getCapability(JujutsucraftaddonModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JujutsucraftaddonModVariables.PlayerVariables())).Clans).equals("Itadori")) {
            ...
            } else {
                {
                    ...
                    if (!_ent.level().isClientSide() && _ent.getServer() != null) {
                        _ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
                                _ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), "execute as @s at @s run title @a[distance=..15] subtitle {\"text\":\"Jujutsu Kaisen!\",\"color\":\"aqua\",\"bold\":true}");
                    }
                }
                {
                    Entity _ent = entity;
                ...
                if (world instanceof Level _level) {
                    if (!_level.isClientSide()) {
                        _level.playSound(null, BlockPos.containing(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jujutsucraftaddon:yujidomain")), SoundSource.NEUTRAL, 1, 1);
                    } else {
                        _level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("jujutsucraftaddon:yujidomain")), SoundSource.NEUTRAL, 1, 1, false);
                    }
                }
            }
        ...
        } else if (entity.getPersistentData().getDouble("skill") == 618) {
            {
                Entity _ent = entity;
                if (!_ent.level().isClientSide() && _ent.getServer() != null) {
                    _ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
                            _ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), "execute as @s at @s run title @a[distance=..15] title {\"text\":\"With this treasure, I summon...\",\"color\":\"white\",\"bold\":true}");
                }
            }
            if (world instanceof Level _level) {
                if (!_level.isClientSide()) {
        ...
        if (entity.getPersistentData().getDouble("skill") == 510) {
            if (world instanceof Level _level) {
                if (!_level.isClientSide()) {
        ...
        } else if (entity.getPersistentData().getDouble("skill") == 515) {
            if (world instanceof Level _level) {
                if (!_level.isClientSide()) {
        ...
        } else if (entity.getPersistentData().getDouble("skill") == 710) {
            {
                Entity _ent = entity;
                if (!_ent.level().isClientSide() && _ent.getServer() != null) {
                    _ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
