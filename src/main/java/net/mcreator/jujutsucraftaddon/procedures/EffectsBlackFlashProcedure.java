...
public class EffectsBlackFlashProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        ...
        if (Math.random() <= 0.1) {
            ...
            world.addParticle(JujutsucraftaddonModParticleTypes.THUNDER_WHITE.get(), x, (y + 1), z, 0, 1, 0);
            world.addParticle(JujutsucraftaddonModParticleTypes.THUNDER_BLACK.get(), x, (y + 1), z, 0, 1, 0);
            world.addParticle(JujutsucraftModParticleTypes.PARTICLE_BLACK_FLASH_1.get(), x, (y + 1), z, 0, 1, 0);
            ...
            for (int index0 = 0; index0 < 5; index0++) {
                for (int index1 = 0; index1 < 11; index1++) {
                    if (r == 2 || r == 3) {
                        ...
                        world.addParticle(JujutsucraftModParticleTypes.PARTICLE_BLACK_FLASH_1.get(), (x - r * Math.sin(Math.toRadians(deg))), (y + 1 + yoff), (z + r * Math.cos(Math.toRadians(deg))),
                                ((-0.1) * Math.sin(Math.toRadians(deg))), 0, (0.1 * Math.cos(Math.toRadians(deg))));
                        world.addParticle(JujutsucraftaddonModParticleTypes.THUNDER_BLACK.get(), (x - r * Math.sin(Math.toRadians(deg))), (y + 1 + yoff), (z + r * Math.cos(Math.toRadians(deg))),
                                ((-0.1) * Math.sin(Math.toRadians(deg))), 0, (0.1 * Math.cos(Math.toRadians(deg))));
                    }
                    deg = deg + 18;
                }
