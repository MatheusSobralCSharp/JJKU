/**
 * Classe customizada de rendering de um layer da entidade Erro
*/
...
public class SukunaRLayer extends GeoRenderLayer<ErroEntity> {
	private static final ResourceLocation LAYER = new ResourceLocation("jujutsucraftaddon", "textures/entities/sukunamark.png");

	public SukunaRLayer(GeoRenderer<ErroEntity> entityRenderer) {
