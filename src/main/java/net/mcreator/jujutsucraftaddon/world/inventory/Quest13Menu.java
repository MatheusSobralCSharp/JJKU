...
public class Quest13Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public Quest13Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(JujutsucraftaddonModMenus.QUEST_13.get(), id);
