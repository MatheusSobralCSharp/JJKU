...
public class StoryModeSukuna3Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public StoryModeSukuna3Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(JujutsucraftaddonModMenus.STORY_MODE_SUKUNA_3.get(), id);
