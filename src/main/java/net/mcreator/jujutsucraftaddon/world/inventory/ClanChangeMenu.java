...
public class ClanChangeMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public ClanChangeMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(JujutsucraftaddonModMenus.CLAN_CHANGE.get(), id);
