...
public class KoganeUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public KoganeUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(JujutsucraftaddonModMenus.KOGANE_UI.get(), id);
