...
public class SkillTreeSPMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public SkillTreeSPMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(JujutsucraftaddonModMenus.SKILL_TREE_SP.get(), id);
