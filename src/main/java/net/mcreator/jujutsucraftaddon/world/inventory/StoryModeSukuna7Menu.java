...
public class StoryModeSukuna7Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public StoryModeSukuna7Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(JujutsucraftaddonModMenus.STORY_MODE_SUKUNA_7.get(), id);
