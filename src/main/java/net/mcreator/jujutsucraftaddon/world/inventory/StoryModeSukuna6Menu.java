...
public class StoryModeSukuna6Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public StoryModeSukuna6Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(JujutsucraftaddonModMenus.STORY_MODE_SUKUNA_6.get(), id);
