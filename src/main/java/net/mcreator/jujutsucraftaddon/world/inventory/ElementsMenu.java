...
public class ElementsMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public ElementsMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(JujutsucraftaddonModMenus.ELEMENTS.get(), id);
