...
public class CursedEnergySelectorMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public CursedEnergySelectorMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(JujutsucraftaddonModMenus.CURSED_ENERGY_SELECTOR.get(), id);
