...
public class Quest9Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public Quest9Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(JujutsucraftaddonModMenus.QUEST_9.get(), id);
