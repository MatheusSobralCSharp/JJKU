...
public class RaceChangeMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public RaceChangeMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(JujutsucraftaddonModMenus.RACE_CHANGE.get(), id);
