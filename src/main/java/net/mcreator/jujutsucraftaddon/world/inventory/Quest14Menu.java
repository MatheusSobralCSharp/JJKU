...
public class Quest14Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public Quest14Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(JujutsucraftaddonModMenus.QUEST_14.get(), id);
