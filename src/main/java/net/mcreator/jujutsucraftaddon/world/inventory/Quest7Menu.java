...
public class Quest7Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public Quest7Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(JujutsucraftaddonModMenus.QUEST_7.get(), id);
