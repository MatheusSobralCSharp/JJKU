...
public class JjkurSetProfessionCommand {
	...
	public static void registerCommand(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("jjkurSetProfession").requires(s -> s.hasPermission(4)).then(Commands.literal("Healer").then(Commands.argument("Player", EntityArgument.player()).executes(arguments -> {
