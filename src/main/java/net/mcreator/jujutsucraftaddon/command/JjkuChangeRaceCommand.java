...
public class JjkuChangeRaceCommand {
    ...
    public static void registerCommand(RegisterCommandsEvent event) {
        event.getDispatcher().register(Commands.literal("jjkuChangeRace").requires(s -> s.hasPermission(2)).then(Commands.literal("CursedSpirit").then(Commands.argument("Player", EntityArgument.player()).executes(arguments -> {
