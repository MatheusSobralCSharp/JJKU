...
import net.mcreator.jujutsucraftaddon.procedures.HakariOnInitialEntitySpawnProcedure;
...
public class HakariEntity extends Monster {
    public HakariEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(JujutsucraftaddonModEntities.HAKARI.get(), world);
    }

    public HakariEntity(EntityType<HakariEntity> type, Level world) {
        super(type, world);
        setMaxUpStep(0.6f);
        xpReward = 0;
        setNoAi(false);
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
        ...
        HakariOnInitialEntitySpawnProcedure.execute(this);
        return retval;
    }
