...
import net.mcreator.jujutsucraftaddon.procedures.SukunaMangaOnEntityTickUpdateProcedure;
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
            ...
            public boolean canUse() {
                double x = SukunaMangaEntity.this.getX();
                double y = SukunaMangaEntity.this.getY();
                double z = SukunaMangaEntity.this.getZ();
                Entity entity = SukunaMangaEntity.this;
                Level world = SukunaMangaEntity.this.level();
