...
public class MakiPreparationEntity extends Monster {
    public MakiPreparationEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(JujutsucraftaddonModEntities.MAKI_PREPARATION.get(), world);
    }

    public MakiPreparationEntity(EntityType<MakiPreparationEntity> type, Level world) {
        super(type, world);
        setMaxUpStep(0.6f);
        xpReward = 0;
        setNoAi(false);
