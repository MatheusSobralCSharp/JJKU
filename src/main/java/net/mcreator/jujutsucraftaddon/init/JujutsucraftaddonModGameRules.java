...
public class JujutsucraftaddonModGameRules {
    ...
    public static final GameRules.Key<GameRules.IntegerValue> JJKU_PURPLE_RANGE = GameRules.register("jjkuPurpleRange", GameRules.Category.MISC, GameRules.IntegerValue.create(40));
    ...
    public static final GameRules.Key<GameRules.IntegerValue> JJKU_SIX_EYES_LEVEL = GameRules.register("jjkuSixEyesLevel", GameRules.Category.MISC, GameRules.IntegerValue.create(5));
    ...
    public static final GameRules.Key<GameRules.IntegerValue> JJKU_AIR_COMBAT_RATE = GameRules.register("jjkuAirCombatRate", GameRules.Category.MISC, GameRules.IntegerValue.create(20));
