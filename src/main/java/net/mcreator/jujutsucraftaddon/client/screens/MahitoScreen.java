...
public class MahitoScreen extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<net.mcreator.jujutsucraftaddon.client.screens.MahitoScreen.AltarOption> options = this.getOptions();
    ...
    private List<net.mcreator.jujutsucraftaddon.client.screens.MahitoScreen.AltarOption> getOptions() {
        List<net.mcreator.jujutsucraftaddon.client.screens.MahitoScreen.AltarOption> options = new ArrayList<>();
        options.add(new MahitoScreen.AltarOption("Strong Attack"));
        options.add(new MahitoScreen.AltarOption("Barrage Attack"));
        options.add(new MahitoScreen.AltarOption("Run Attack"));
        options.add(new MahitoScreen.AltarOption("Jump Attack"));
        options.add(new MahitoScreen.AltarOption("Multiple Body Repel"));
        options.add(new MahitoScreen.AltarOption("Slash Attack"));
        options.add(new MahitoScreen.AltarOption("Human Gun"));
        options.add(new MahitoScreen.AltarOption("Clone"));
        return options;
    }
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            net.mcreator.jujutsucraftaddon.client.screens.MahitoScreen.AltarOption item = this.getCurrent().get(i);
            int white = toRGB24(255, 255, 255, 150);
            int black = toRGB24(75, 0, 130, 150);
            ...
            if (this.hovered > 0) {
                ...
                AltarMessageMahito.pressAction(Minecraft.getInstance().player, this.hovered);
    ...
    private List<? extends net.mcreator.jujutsucraftaddon.client.screens.MahitoScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends net.mcreator.jujutsucraftaddon.client.screens.MahitoScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        net.mcreator.jujutsucraftaddon.client.screens.MahitoScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
