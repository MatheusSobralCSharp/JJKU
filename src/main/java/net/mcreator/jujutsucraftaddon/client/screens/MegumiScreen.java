...
import net.mcreator.jujutsucraftaddon.network.AltarMessageMegumi;
...
public class MegumiScreen extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption> options = this.getOptions();
    ...
    private List<net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption> getOptions() {
        List<net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption> options = new ArrayList<>();
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption("Divine Dog Totality"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption("Nue"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption("Serpent"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption("Toad"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption("Max Elephant"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption("Rabbit Escape"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption("Round Deer"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption("Piercing Ox"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption("Tiger Funeral"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption("Agito"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption("MAHORAGA"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption("Piercing Water"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption("Giant Nue"));
        return options;
    }
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption item = this.getCurrent().get(i);
    ...
    private List<? extends net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        net.mcreator.jujutsucraftaddon.client.screens.MegumiScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
