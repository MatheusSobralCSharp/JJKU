...
public class ItadoriScreen extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<net.mcreator.jujutsucraftaddon.client.screens.ItadoriScreen.AltarOption> options = this.getOptions();
    ...
    private List<net.mcreator.jujutsucraftaddon.client.screens.ItadoriScreen.AltarOption> getOptions() {
        List<net.mcreator.jujutsucraftaddon.client.screens.ItadoriScreen.AltarOption> options = new ArrayList<>();
        options.add(new ItadoriScreen.AltarOption("Strong Attack"));
        options.add(new ItadoriScreen.AltarOption("Barrage Attack"));
        options.add(new ItadoriScreen.AltarOption("Run Attack"));
        options.add(new ItadoriScreen.AltarOption("Jump Attack"));
        options.add(new ItadoriScreen.AltarOption("Piercing Blood"));
        options.add(new ItadoriScreen.AltarOption("Soul Dismantle"));
        options.add(new ItadoriScreen.AltarOption("Soul Cleave"));
        options.add(new ItadoriScreen.AltarOption("Benevolent Shrine"));
        return options;
    }
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            net.mcreator.jujutsucraftaddon.client.screens.ItadoriScreen.AltarOption item = this.getCurrent().get(i);
            ...
            if (this.hovered > 0) {
                ...
                AltarMessageItadori.pressAction(Minecraft.getInstance().player, this.hovered);
    ...
    private List<? extends net.mcreator.jujutsucraftaddon.client.screens.ItadoriScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends net.mcreator.jujutsucraftaddon.client.screens.ItadoriScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        net.mcreator.jujutsucraftaddon.client.screens.ItadoriScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
