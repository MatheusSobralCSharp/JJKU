...
import net.mcreator.jujutsucraftaddon.network.AltarMessageTwo;
...
public class TodoScreen extends Screen {
    ...
    private final List<List<net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption>> pages = new ArrayList<>();
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption> options = this.getOptions();
    ...
    private List<net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption> getOptions() {
        List<net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption> options = new ArrayList<>();
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption("Boogie Woogie"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption("Quick Attack"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption("Swap"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption("Itadori"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption("Vibraslap"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption("Swap Team Attack"));
        options.add(new net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption("Boogie Woogie Deflect"));
        return options;
    }
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption item = this.getCurrent().get(i);
            ...
            if (this.hovered > 0) {
                ...
                AltarMessageTwo.pressAction(Minecraft.getInstance().player, this.hovered);
    ...
    private List<? extends net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        net.mcreator.jujutsucraftaddon.client.screens.TodoScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
