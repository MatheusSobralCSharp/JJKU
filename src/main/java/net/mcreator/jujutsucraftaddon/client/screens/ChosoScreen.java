...
import net.mcreator.jujutsucraftaddon.network.AltarMessageThree;
...
public class ChosoScreen extends Screen {
    ...
    private final List<List<ChosoScreen.AltarOption>> pages = new ArrayList<>();
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<net.mcreator.jujutsucraftaddon.client.screens.ChosoScreen.AltarOption> options = this.getOptions();
    ...
    private List<net.mcreator.jujutsucraftaddon.client.screens.ChosoScreen.AltarOption> getOptions() {
        List<net.mcreator.jujutsucraftaddon.client.screens.ChosoScreen.AltarOption> options = new ArrayList<>();
        options.add(new ChosoScreen.AltarOption("Slicing Exorcism"));
        options.add(new ChosoScreen.AltarOption("Piercing Blood"));
        options.add(new ChosoScreen.AltarOption("Blood Poison"));
        options.add(new ChosoScreen.AltarOption("Flowing Red Scale: Stack"));
        options.add(new ChosoScreen.AltarOption("Itadori"));
        options.add(new ChosoScreen.AltarOption("Blood Recovery"));
        options.add(new ChosoScreen.AltarOption("Senketsu: Piercing Blood"));
        options.add(new ChosoScreen.AltarOption("Convergence"));
        options.add(new ChosoScreen.AltarOption("Super Nova"));
        return options;
    }
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            net.mcreator.jujutsucraftaddon.client.screens.ChosoScreen.AltarOption item = this.getCurrent().get(i);
            int white = toRGB24(255, 255, 255, 150);
            int black = toRGB24(255, 0, 0, 150);
            ...
            if (this.hovered > 0) {
                ...
                AltarMessageThree.pressAction(Minecraft.getInstance().player, this.hovered);
    ...
    private List<? extends net.mcreator.jujutsucraftaddon.client.screens.ChosoScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends net.mcreator.jujutsucraftaddon.client.screens.ChosoScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        net.mcreator.jujutsucraftaddon.client.screens.ChosoScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
