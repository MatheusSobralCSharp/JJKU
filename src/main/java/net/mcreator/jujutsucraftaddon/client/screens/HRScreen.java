...
import net.mcreator.jujutsucraftaddon.network.AltarMessageHR;
...
public class HRScreen extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<net.mcreator.jujutsucraftaddon.client.screens.HRScreen.AltarOption> options = this.getOptions();
    ...
    private List<net.mcreator.jujutsucraftaddon.client.screens.HRScreen.AltarOption> getOptions() {
        List<net.mcreator.jujutsucraftaddon.client.screens.HRScreen.AltarOption> options = new ArrayList<>();
        options.add(new HRScreen.AltarOption("Strong Attack"));
        options.add(new HRScreen.AltarOption("Barrage Attack"));
        options.add(new HRScreen.AltarOption("Run Attack"));
        options.add(new HRScreen.AltarOption("Jump Attack"));
        options.add(new HRScreen.AltarOption("Domain Breaker"));
        options.add(new HRScreen.AltarOption("Six Eyes Cut"));
        options.add(new HRScreen.AltarOption("Split Soul Cut"));
        options.add(new HRScreen.AltarOption("Ground Breaker"));
        options.add(new HRScreen.AltarOption("Healing"));
        return options;
    }
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            net.mcreator.jujutsucraftaddon.client.screens.HRScreen.AltarOption item = this.getCurrent().get(i);
            ...
            if (this.hovered > 0) {
                ...
                if (this.hovered != 7) {
                    AltarMessageHR.pressAction(Minecraft.getInstance().player, this.hovered);
                }
    ...
    private List<? extends net.mcreator.jujutsucraftaddon.client.screens.HRScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends net.mcreator.jujutsucraftaddon.client.screens.HRScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        net.mcreator.jujutsucraftaddon.client.screens.HRScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
