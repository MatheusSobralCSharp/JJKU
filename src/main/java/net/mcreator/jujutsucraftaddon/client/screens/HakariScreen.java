...
import net.mcreator.jujutsucraftaddon.network.AltarMessageHakari;
...
public class HakariScreen extends Screen {
    ...
    protected void init() {
        ...
        this.pages.clear();
        List<net.mcreator.jujutsucraftaddon.client.screens.HakariScreen.AltarOption> options = this.getOptions();
    ...
    private List<net.mcreator.jujutsucraftaddon.client.screens.HakariScreen.AltarOption> getOptions() {
        List<net.mcreator.jujutsucraftaddon.client.screens.HakariScreen.AltarOption> options = new ArrayList<>();
        options.add(new HakariScreen.AltarOption("Strong Attack"));
        options.add(new HakariScreen.AltarOption("Barrage Attack"));
        options.add(new HakariScreen.AltarOption("Run Attack"));
        options.add(new HakariScreen.AltarOption("Jump Attack"));
        options.add(new HakariScreen.AltarOption("Ground Break"));
        options.add(new HakariScreen.AltarOption("Doors"));
        options.add(new HakariScreen.AltarOption("Kick Attack"));
        return options;
    }
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        for (int i = 0; i < this.getCurrent().size(); i++) {
            ...
            net.mcreator.jujutsucraftaddon.client.screens.HakariScreen.AltarOption item = this.getCurrent().get(i);
            int white = toRGB24(255, 255, 255, 150);
            int black = toRGB24(0, 100, 0, 150);
            ...
            if (this.hovered > 0) {
                ...
                if (this.hovered != 4) {
                    AltarMessageHakari.pressAction(Minecraft.getInstance().player, this.hovered);
                }
    ...
    private List<? extends net.mcreator.jujutsucraftaddon.client.screens.HakariScreen.AltarOption> getCurrent() {
    ...
    public void onClose() {
        ...
        List<? extends net.mcreator.jujutsucraftaddon.client.screens.HakariScreen.AltarOption> items = this.pages.get(page);

        if (this.hovered >= items.size()) return;

        net.mcreator.jujutsucraftaddon.client.screens.HakariScreen.AltarOption item = items.get(this.hovered);
        item.onSelect();
    }
