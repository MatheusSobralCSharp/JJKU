...
import net.mcreator.jujutsucraftaddon.item.model.DecisiveModel;
import net.mcreator.jujutsucraftaddon.item.DecisiveItem;

public class DecisiveArmorRenderer extends GeoArmorRenderer<DecisiveItem> {
    public DecisiveArmorRenderer() {
        super(new DecisiveModel());
    ...
    @Override
    public RenderType getRenderType(DecisiveItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
