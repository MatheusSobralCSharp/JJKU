...
import net.mcreator.jujutsucraftaddon.item.model.KimonoWhiteModel;
import net.mcreator.jujutsucraftaddon.item.KimonoWhiteItem;

public class KimonoWhiteArmorRenderer extends GeoArmorRenderer<KimonoWhiteItem> {
	public KimonoWhiteArmorRenderer() {
		super(new KimonoWhiteModel());
	...
	@Override
	public RenderType getRenderType(KimonoWhiteItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
