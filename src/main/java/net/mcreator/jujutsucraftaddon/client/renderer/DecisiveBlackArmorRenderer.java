...
import net.mcreator.jujutsucraftaddon.item.model.DecisiveBlackModel;
...
public class DecisiveBlackArmorRenderer extends GeoArmorRenderer<DecisiveBlackItem> {
    public DecisiveBlackArmorRenderer() {
        super(new DecisiveBlackModel());
    ...
    @Override
    public RenderType getRenderType(DecisiveBlackItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
