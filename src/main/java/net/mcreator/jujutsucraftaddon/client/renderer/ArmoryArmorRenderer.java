...
import net.mcreator.jujutsucraftaddon.item.model.ArmoryModel;
import net.mcreator.jujutsucraftaddon.item.ArmoryItem;

public class ArmoryArmorRenderer extends GeoArmorRenderer<ArmoryItem> {
    public ArmoryArmorRenderer() {
        super(new ArmoryModel());
    ...
    @Override
    public RenderType getRenderType(ArmoryItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
