...
import net.mcreator.jujutsucraftaddon.item.model.KimonoBlackModel;
import net.mcreator.jujutsucraftaddon.item.KimonoBlackItem;

public class KimonoBlackArmorRenderer extends GeoArmorRenderer<KimonoBlackItem> {
	public KimonoBlackArmorRenderer() {
		super(new KimonoBlackModel());
	...
	@Override
	public RenderType getRenderType(KimonoBlackItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
