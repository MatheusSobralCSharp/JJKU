...
import net.mcreator.jujutsucraftaddon.network.StoryModeGojo6ButtonMessage;
...
public class StoryModeGojo6Screen extends AbstractContainerScreen<StoryModeGojo6Menu> {
	...
	public void init() {
		...
		button_start = Button.builder(Component.translatable("gui.jujutsucraftaddon.story_mode_gojo_6.button_start"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new StoryModeGojo6ButtonMessage(0, x, y, z, textstate));
				StoryModeGojo6ButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
