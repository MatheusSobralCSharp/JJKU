...
public class Quest2Screen extends AbstractContainerScreen<Quest2Menu> {
    ...
    public void init() {
        ...
        button_continue = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_2.button_continue"), e -> {
            if (true) {
                JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest2ButtonMessage(0, x, y, z, textstate));
                Quest2ButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
            }
        ...
        button_reset = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_2.button_reset"), e -> {
            if (true) {
                JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest2ButtonMessage(1, x, y, z, textstate));
                Quest2ButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
            }
