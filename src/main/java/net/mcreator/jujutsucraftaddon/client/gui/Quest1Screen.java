...
public class Quest1Screen extends AbstractContainerScreen<Quest1Menu> {
	...
	public void init() {
		...
		button_start = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_1.button_start"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest1ButtonMessage(0, x, y, z, textstate));
				Quest1ButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
