...
public class ProfessionGUIScreen extends AbstractContainerScreen<ProfessionGUIMenu> {
	...
	public void init() {
		...
		button_healer = Button.builder(Component.translatable("gui.jujutsucraftaddon.profession_gui.button_healer"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new ProfessionGUIButtonMessage(0, x, y, z, textstate));
				ProfessionGUIButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
		...
		button_blacksmith = Button.builder(Component.translatable("gui.jujutsucraftaddon.profession_gui.button_blacksmith"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new ProfessionGUIButtonMessage(1, x, y, z, textstate));
				ProfessionGUIButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
			}
		...
		button_warrior = Button.builder(Component.translatable("gui.jujutsucraftaddon.profession_gui.button_warrior"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new ProfessionGUIButtonMessage(2, x, y, z, textstate));
				ProfessionGUIButtonMessage.handleButtonAction(entity, 2, x, y, z, textstate);
			}
		...
		button_jujutsu_sage = Button.builder(Component.translatable("gui.jujutsucraftaddon.profession_gui.button_jujutsu_sage"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new ProfessionGUIButtonMessage(3, x, y, z, textstate));
				ProfessionGUIButtonMessage.handleButtonAction(entity, 3, x, y, z, textstate);
			}
