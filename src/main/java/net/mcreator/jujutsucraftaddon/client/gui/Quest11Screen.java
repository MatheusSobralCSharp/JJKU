...
import net.mcreator.jujutsucraftaddon.network.Quest11ButtonMessage;
...
public class Quest11Screen extends AbstractContainerScreen<Quest11Menu> {
	...
	public void init() {
		...
		button_continue = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_11.button_continue"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest11ButtonMessage(0, x, y, z, textstate));
				Quest11ButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
		...
		button_reset = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_11.button_reset"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest11ButtonMessage(1, x, y, z, textstate));
				Quest11ButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
			}
