...
public class StoryModeGojo1Screen extends AbstractContainerScreen<StoryModeGojo1Menu> {
	...
	public void init() {
		...
		button_start = Button.builder(Component.translatable("gui.jujutsucraftaddon.story_mode_gojo_1.button_start"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new StoryModeGojo1ButtonMessage(0, x, y, z, textstate));
				StoryModeGojo1ButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
