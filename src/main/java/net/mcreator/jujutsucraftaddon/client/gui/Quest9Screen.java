...
public class Quest9Screen extends AbstractContainerScreen<Quest9Menu> {
    ...
    public void init() {
        ...
        button_continue = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_9.button_continue"), e -> {
            if (true) {
                JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest9ButtonMessage(0, x, y, z, textstate));
                Quest9ButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
            }
        ...
        button_reset = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_9.button_reset"), e -> {
            if (true) {
                JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest9ButtonMessage(1, x, y, z, textstate));
                Quest9ButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
            }
