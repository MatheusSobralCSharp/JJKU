...
public class Quest5Screen extends AbstractContainerScreen<Quest5Menu> {
    ...
    public void init() {
        ...
        button_continue = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_5.button_continue"), e -> {
            if (true) {
                JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest5ButtonMessage(0, x, y, z, textstate));
                Quest5ButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
            }
        ...
        button_reset = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_5.button_reset"), e -> {
            if (true) {
                JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest5ButtonMessage(1, x, y, z, textstate));
                Quest5ButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
            }
