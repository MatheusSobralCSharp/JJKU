...
import net.mcreator.jujutsucraftaddon.network.Quest8ButtonMessage;
...
public class Quest8Screen extends AbstractContainerScreen<Quest8Menu> {
	...
	public void init() {
		...
		button_continue = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_8.button_continue"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest8ButtonMessage(0, x, y, z, textstate));
				Quest8ButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
		...
		button_reset = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_8.button_reset"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest8ButtonMessage(1, x, y, z, textstate));
				Quest8ButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
			}
