...
public class Quest14Screen extends AbstractContainerScreen<Quest14Menu> {
	...
	public void init() {
		...
		button_continue = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_14.button_continue"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest14ButtonMessage(0, x, y, z, textstate));
				Quest14ButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
		...
		button_reset = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_14.button_reset"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest14ButtonMessage(1, x, y, z, textstate));
				Quest14ButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
			}
