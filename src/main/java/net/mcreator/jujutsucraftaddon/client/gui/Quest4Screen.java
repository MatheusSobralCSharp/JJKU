...
public class Quest4Screen extends AbstractContainerScreen<Quest4Menu> {
    ...
    public void init() {
        ...
        button_continue = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_4.button_continue"), e -> {
            if (true) {
                JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest4ButtonMessage(0, x, y, z, textstate));
                Quest4ButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
            }
        ...
        button_reset = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_4.button_reset"), e -> {
            if (true) {
                JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest4ButtonMessage(1, x, y, z, textstate));
                Quest4ButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
            }
