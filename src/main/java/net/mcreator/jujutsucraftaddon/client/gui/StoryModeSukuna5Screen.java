...
public class StoryModeSukuna5Screen extends AbstractContainerScreen<StoryModeSukuna5Menu> {
	...
	public void init() {
		...
		button_start = Button.builder(Component.translatable("gui.jujutsucraftaddon.story_mode_sukuna_5.button_start"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new StoryModeSukuna5ButtonMessage(0, x, y, z, textstate));
				StoryModeSukuna5ButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
