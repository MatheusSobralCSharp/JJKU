...
public class GojoTrainScreen extends AbstractContainerScreen<GojoTrainMenu> {
	...
	public void init() {
		...
		button_start = Button.builder(Component.translatable("gui.jujutsucraftaddon.gojo_train.button_start"), e -> {
			if (true) {
				JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new GojoTrainButtonMessage(0, x, y, z, textstate));
				GojoTrainButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
			}
