...
public class Quest3Screen extends AbstractContainerScreen<Quest3Menu> {
    ...
    public void init() {
        ...
        button_continue = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_3.button_continue"), e -> {
            if (true) {
                JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest3ButtonMessage(0, x, y, z, textstate));
                Quest3ButtonMessage.handleButtonAction(entity, 0, x, y, z, textstate);
            }
        ...
        button_reset = Button.builder(Component.translatable("gui.jujutsucraftaddon.quest_3.button_reset"), e -> {
            if (true) {
                JujutsucraftaddonMod.PACKET_HANDLER.sendToServer(new Quest3ButtonMessage(1, x, y, z, textstate));
                Quest3ButtonMessage.handleButtonAction(entity, 1, x, y, z, textstate);
            }
