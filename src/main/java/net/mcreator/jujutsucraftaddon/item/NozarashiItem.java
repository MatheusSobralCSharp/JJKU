...
import net.mcreator.jujutsucraftaddon.procedures.NozarashiToolInHandTickProcedure;
import net.mcreator.jujutsucraftaddon.procedures.NozarashiRightclickedProcedure;
import net.mcreator.jujutsucraftaddon.procedures.NozarashiLivingEntityIsHitWithToolProcedure;
import net.mcreator.jujutsucraftaddon.procedures.NozarashiEntitySwingsItemProcedure;
...
public class NozarashiItem extends SwordItem {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("[Ability] Can Cut Through Anything"));
	}
